...
from api import AccountService, Chain, BridgeService
    ...
    kb = [
        [
            InlineKeyboardButton(
                "Hyperliquid Core",
                callback_data=f"{StartStates.TRIGGER.value}|{Command.HYPERLIQUID_CORE_START}",
            ),
        ],
        [
            InlineKeyboardButton(
                "📊 Balance(evm)",
                callback_data=f"{EvmBalanceState.START.value}",
            ),
            InlineKeyboardButton(
                "🤖 Auto LP Manager",
                callback_data=f"{StartStates.TRIGGER.value}|{Command.LPVAULT_AUTO}",
            ),
        ],
        [
            InlineKeyboardButton(
                "👥 Referral",
                callback_data=f"{StartStates.TRIGGER.value}|{Command.REFERRAL}",
            ),
            InlineKeyboardButton(
                "⚙️ Wallet",
                callback_data=f"{StartStates.TRIGGER.value}|{Command.WALLET}|{Command.START}",
            ),
        ],
        [
            InlineKeyboardButton(
        ...
        [
            InlineKeyboardButton(
                "Privy",
                web_app=WebAppInfo(url="https://test.hypurrquant.com/privy/telegram"),
            ),
        ],
    ]
        ...
        kb.append(
            [
                InlineKeyboardButton(
                    "labs for test",
                    web_app=WebAppInfo(
                        url="https://test.hypurrquant.com/privy/dev/lab"
                    ),
                ),
            ]
        )
